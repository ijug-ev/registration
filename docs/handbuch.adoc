...
. Fertig – die Seite ist unter `/meeting/{mandant}/{eventId}` erreichbar und zeigt Titel,
...
|`meeting.tools`
|Hinweis zu den eingesetzten Konferenzwerkzeugen auf der Meeting-Seite
|===
...
|Die Meeting-Seite meldet „nicht verfügbar"
|Sie ist nur am Tag der Veranstaltung erreichbar. Andernfalls fehlt der Meeting-Link oder
